...
optional_secrets=(OPENAI_API_KEY OLLAMA_API_KEY OPENROUTER_API_KEY TRACE_API_TOKEN REFLECT_SERVICE_TOKEN AGENT_API_TOKEN TURNSTILE_SECRET_KEY DISCORD_TOKEN CLOUDINARY_API_KEY CLOUDINARY_API_SECRET GITHUB_WEBHOOK_SECRET)
