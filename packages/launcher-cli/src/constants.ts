...
export const LAUNCHER_ID = 'launcher-cli-v1';
export const DEFAULT_PREFERRED_PORT = 8080;
export const DEFAULT_READINESS_TIMEOUT_MS = 90_000;
export const DEFAULT_CONTAINER_NAME = 'footnote-server';
export const DEFAULT_VOLUME_NAME = 'footnote_data';
