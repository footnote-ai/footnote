...
const InvitePage: React.FC = () => {
    ...
    const [installToast, setInstallToast] = useState<ToastState>({
        message: '',
        visible: false,
    });
    const [devToast, setDevToast] = useState<ToastState>({
        message: '',
        visible: false,
    });
    const [buildToast, setBuildToast] = useState<ToastState>({
        message: '',
        visible: false,
    });
    const [launchToast, setLaunchToast] = useState<ToastState>({
        message: '',
        visible: false,
    });
    const [deployToast, setDeployToast] = useState<ToastState>({
        message: '',
        visible: false,
    });
    const [requiredToast, setRequiredToast] = useState<ToastState>({
        message: '',
        visible: false,
    });
    const [optionalToast, setOptionalToast] = useState<ToastState>({
        message: '',
        visible: false,
    });
            ...
            <main>
                <section className="hero" aria-labelledby="hero-title">
                    <div className="hero-copy">
                        ...
                        <p>For beginners and advanced users alike.</p>
                    </div>
                </section>
...
WEB_BASE_URL=https://your-domain.com       # Base URL for web server (String)`}
                            ...
                            <p>
                                ...
                                sample. See <code>.env.example</code> for the
                    ...
                    <div className="card" aria-labelledby="running-title">
                        ...
                        <p>
                            This will start the backend and the web interface.
                            The web interface will be available at{' '}
                            <code>http://localhost:5173</code>.
                        </p>
                        <p>
                            To run the Discord bot separately, use:{' '}
                            <code>pnpm start:bot</code>
                        </p>
                        <p>
                    ...
                    <div className="card" aria-labelledby="deployment-title">
                        ...
                        <div className="feature-card">
                            ...
                            <p>
                                Make sure to set your environment variables in
                                the Fly.io dashboard after deployment.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="card" aria-labelledby="resources-title">
                        ...
                        <div className="services-grid">
                            ...
                            <div className="feature-card">
                                ...
                                <p>
                                    Learn how to create and configure Discord
                                    bots
                                </p>
                                <a
